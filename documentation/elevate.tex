...
\begin{codeblock}{HabitService.ts}
  ...
  export class HabitService {
    ...
    // Szokásadatok lekérése
    getHabits(): Observable<HabitLog[]> {
      return this.http.get<HabitLog[]>(this.apiUrl);
    }

    // Szokás frissítése
    updateHabitLog(id: string, habitLog: HabitLog): Observable<HabitLog> {
      return this.http.put<HabitLog>(`${this.apiUrl}/${id}`, habitLog);
    }
  }
  }
\end{codeblock}
